  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Exceptions Central Workspace</h1>
          <p className="text-xs text-slate-400 mt-1">Review, investigate, and resolve financial discrepancies</p>
        </div>
